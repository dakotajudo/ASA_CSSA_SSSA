...
bmp('TxTSmyCol2.bmp', width = 620, height = 500, units = 'px', pointsize = 10, bg = 'white')
par(fig = c(0, 1, 0.4, 1), mar = (c(1, 7, 2, 1) + 0.1), ps = 10, cex.lab = 1.4, cex.main = 1.6, cex.axis = 1)
plot.interaction.ARMST(means.matrix, means.vector, ylab='Treatment in Trial Mean \nPlant Height',regression=TRUE, main='Treatment Stability and Trial Clusters for Grand Mean 2', show.legend=TRUE,legend.columns=2, legend.pos=c(.01,.98))
