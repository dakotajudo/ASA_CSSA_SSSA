...
Fig2.plan$rep <- Fig2.plan$row
Fig2.dist <- pair.distances(Fig2.plan)
Fig2.dist


Fig2.tbl <- make.pairs.table(Fig2.dist)
Fig2.mat <- make.pairs.matrices(Fig2.tbl)
Fig2.mat
```
